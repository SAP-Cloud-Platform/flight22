@AbapCatalog.sqlViewName: '/DMO/CURRHLP22'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER22
  with parameters
    amount             : /dmo/total_price22,
    source_currency    : /dmo/currency_code22,
    target_currency    : /dmo/currency_code22,
    exchange_rate_date : /dmo/booking_date22

  as select from /dmo/agency22
