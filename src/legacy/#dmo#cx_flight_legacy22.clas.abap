CLASS /dmo/cx_flight_legacy22 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_22',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_22',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id22 OPTIONAL
        booking_id            TYPE /dmo/booking_id22 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id22 OPTIONAL
        agency_id             TYPE /dmo/agency_id22 OPTIONAL
        customer_id           TYPE /dmo/customer_id22 OPTIONAL
        carrier_id            TYPE /dmo/carrier22-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_22-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_22-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date22 OPTIONAL
        end_date              TYPE /dmo/end_date22 OPTIONAL
        booking_date          TYPE /dmo/booking_date22 OPTIONAL
        flight_date           TYPE /dmo/flight_date22 OPTIONAL
        status                TYPE /dmo/travel_status22 OPTIONAL
        currency_code         TYPE /dmo/currency_code22 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id22,
          mv_booking_id            TYPE /dmo/booking_id22,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id22,
          mv_agency_id             TYPE /dmo/agency_id22,
          mv_customer_id           TYPE /dmo/customer_id22,
          mv_carrier_id            TYPE /dmo/carrier22-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_22-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_22-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date22,
          mv_end_date              TYPE /dmo/end_date22,
          mv_booking_date          TYPE /dmo/booking_date22,
          mv_flight_date           TYPE /dmo/flight_date22,
          mv_status                TYPE /dmo/travel_status22,
          mv_currency_code         TYPE /dmo/currency_code22,
...
CLASS /dmo/cx_flight_legacy22 IMPLEMENTATION.
