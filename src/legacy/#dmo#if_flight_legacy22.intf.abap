...
INTERFACE /dmo/if_flight_legacy22
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL22
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel22     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING22
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking22    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_22
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_22 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT22
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight22 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id22.
  ...
  TYPES booking_id TYPE /dmo/booking_id22.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id22.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL22, /DMO/BOOKING22, /DMO/BOOK_SUP_22 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code22.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code22,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status22,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel22_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id22.
  INCLUDE TYPE /dmo/booking22_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id22.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id22.
  INCLUDE TYPE /dmo/book_sup_22_data.
